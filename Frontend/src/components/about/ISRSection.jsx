...
function InitiativeCard({ icon: Icon, title, description, items, delay = 0, index }) {
  ...
  return (
    <div
      ref={ref}
      className={cn(
        "group relative flex flex-col p-5 rounded-xl border border-gray-100 bg-white transition-all duration-300",
    ...
    >
      <div className="flex items-start gap-3 mb-3">
        ...
        <h3 className="text-sm font-bold text-gray-900 mt-1 group-hover:text-primary transition-colors">
          {title}
        </h3>
      </div>
            ...
            <RevealOnScroll>
              <div className="bg-white rounded-xl border border-gray-100 p-6 shadow-sm relative overflow-hidden">
                ...
                <div className="flex flex-col sm:flex-row gap-5 items-start">
                  <div className="flex-shrink-0 p-3 rounded-xl bg-gradient-to-br from-primary/10 to-accent/5 border border-primary/10">
          ...
          <div className="lg:col-span-4 space-y-4">
            ...
            <RevealOnScroll delay={400}>
              <div className="bg-primary rounded-xl p-6 text-white shadow-md relative overflow-hidden group">
                ...
                <div className="relative z-10">
                  <Lightbulb className="w-6 h-6 mb-3 text-accent" />
                  <p className="text-xs leading-relaxed opacity-90 italic mb-3">
