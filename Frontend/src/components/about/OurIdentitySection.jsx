        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
          ...
          <div className="lg:col-span-8 space-y-6">
            ...
            <RevealOnScroll delay={100}>
              <div className="rounded-xl bg-gradient-to-br from-primary/5 via-transparent to-accent/5 border border-primary/10 p-6 flex flex-col sm:flex-row items-center gap-6">
                <div className="relative w-32 h-32 flex-shrink-0 rounded-full bg-white p-4 shadow-sm border border-gray-100">
                  <Image
              ...
              <div className="bg-primary rounded-xl p-5 text-white shadow-md relative overflow-hidden group">
                ...
                <div className="flex flex-wrap gap-2">
                  {["Growth", "Knowledge", "Integrity", "Innovation", "Unity"].map((val) => (
                    <span key={val} className="px-2.5 py-1 rounded-md bg-white/10 text-xs font-medium backdrop-blur-sm border border-white/10">
                      {val}
                    </span>
                  ))}
                </div>
