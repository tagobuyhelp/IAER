...
export default function InternationalImmersion() {
    return (
        <section className="py-16 md:py-24 bg-gradient-to-b from-neutral-950 via-neutral-900 to-black overflow-hidden">
            <div className="container mx-auto px-4">
                <div className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-gradient-to-br from-white/10 via-white/5 to-white/0 shadow-[0_40px_120px_rgba(0,0,0,0.9)] px-6 py-10 md:px-10 md:py-12 backdrop-blur-xl">
                    ...
                    {/* Left Content */}
                    <div className="flex-1 space-y-8 lg:space-y-10 lg:sticky lg:top-24">
                        <RevealOnScroll>
                            <div className="inline-flex items-center gap-4 px-6 py-3 rounded-full bg-gradient-to-r from-emerald-400 via-sky-400 to-blue-500 text-neutral-950 shadow-xl shadow-emerald-500/20">
                        ...
                        <RevealOnScroll delay={200}>
                            <p className="text-neutral-100/90 text-base md:text-lg leading-relaxed text-justify font-medium">
                        ...
                        <RevealOnScroll delay={400}>
                            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 max-w-md">
                                <div className="rounded-2xl border border-white/10 bg-white/5 px-4 py-3 shadow-lg shadow-black/40">
                                    ...
                                    <p className="text-[11px] text-neutral-200/80 mt-1">
                                ...
                                <div className="rounded-2xl border border-white/10 bg-white/5 px-4 py-3 shadow-lg shadow-black/40">
                                    ...
                                    <p className="text-xl md:text-1xl font-black text-white">
                                        Academic &amp; Industry
                                    </p>
                                    <p className="text-[11px] text-neutral-200/80 mt-1">
                                ...
                                <div className="rounded-2xl border border-white/10 bg-white/5 px-4 py-3 shadow-lg shadow-black/40 col-span-2 sm:col-span-1">
                            ...
                            {countries.map((country, index) => (
                                <RevealOnScroll key={country.name} delay={index * 120}>
                                    ...
                                    >
                                        ...
                                        {/* Content */}
                                        <div className="absolute inset-x-0 bottom-0 p-4 md:p-5 text-center transform translate-y-1 group-hover:translate-y-0 transition-transform duration-500">
                                            <span className="inline-flex items-center justify-center rounded-full bg-white/10 px-4 py-1 backdrop-blur-sm text-white font-black text-[11px] md:text-xs uppercase tracking-[0.25em] drop-shadow-md">
                                                {country.name}
                                            </span>
