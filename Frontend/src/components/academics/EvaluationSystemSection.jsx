    ...
    <div id="academics-evaluation-system" className="relative py-16 bg-gray-50/50 overflow-hidden">
      ...
      <section className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto min-h-[400px]">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-12">
                ...
                <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 hover:shadow-md transition-all">
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <div>
                        <h3 className="text-xl font-bold text-[#100902]">Internal Assessment</h3>
                ...
                <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 hover:shadow-md transition-all">
                  <div className="flex items-center gap-4 mb-6">
                    <div className="w-12 h-12 bg-orange-50 rounded-2xl flex items-center justify-center text-accent shrink-0">
                      <GraduationCap className="w-6 h-6" />
                    </div>
                    <div>
                        <h3 className="text-xl font-bold text-[#100902]">External Assessment</h3>
          ...
          {activeTab === "weightage" && (
            <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
               <div className="bg-white rounded-3xl p-8 lg:p-12 shadow-xl shadow-gray-100 border border-gray-100">
                  <div className="flex flex-col lg:flex-row gap-12">
                      {/* Table Section */}
                      <div className="lg:w-1/2">
                          <h3 className="text-2xl font-bold text-[#100902] mb-6 flex items-center gap-2">
                          ...
                          <div className="overflow-hidden rounded-xl border border-gray-200 shadow-sm">
                            <table className="w-full text-sm text-left">
                                ...
                                <tr className="hover:bg-gray-50/50 transition-colors">
                                    <td className="px-6 py-4 font-bold text-[#100902]">Theory</td>
                                    <td className="px-6 py-4 text-center text-gray-600 bg-blue-50/30">40%</td>
                                    <td className="px-6 py-4 text-center text-gray-600 bg-orange-50/30">60%</td>
                                    <td className="px-6 py-4 text-center font-bold text-[#100902]">100%</td>
                                </tr>
                                <tr className="hover:bg-gray-50/50 transition-colors">
                                    <td className="px-6 py-4 font-bold text-[#100902]">Practical</td>
                                    <td className="px-6 py-4 text-center text-gray-600 bg-blue-50/30">60%</td>
                                    <td className="px-6 py-4 text-center text-gray-600 bg-orange-50/30">40%</td>
                                    <td className="px-6 py-4 text-center font-bold text-[#100902]">100%</td>
                                </tr>
                                </tbody>
                            </table>
                      ...
                      <div className="lg:w-1/2 flex flex-col justify-center space-y-6">
                          <div className="bg-[#100902] text-white p-6 rounded-2xl relative overflow-hidden">
            ...
            <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {[
                        ...
                        <div key={i} className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-all flex flex-col gap-4">
                            <div className={cn("w-10 h-10 rounded-lg flex items-center justify-center shrink-0", item.bg)}>
                                <item.icon className={cn("w-5 h-5", item.color)} />
                            </div>
                            <div>
                                <h4 className="font-bold text-[#100902] mb-1 text-base">{item.title}</h4>
