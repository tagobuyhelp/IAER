                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                    {events.map((event, index) => (
                        <RevealOnScroll key={index} delay={index * 100}>
                            <div className="bg-gray-50 hover:bg-white p-8 rounded-2xl transition-all duration-300 hover:shadow-xl border border-gray-100 hover:border-accent/20 group h-full">
