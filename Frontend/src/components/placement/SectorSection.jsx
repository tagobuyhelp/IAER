...
export default function SectorSection() {
    return (
        <section id="sectors" className="py-20 bg-accent text-white">
            <div className="container mx-auto px-4">
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    <RevealOnScroll>
                        <h2 className="text-3xl lg:text-4xl font-bold mb-6">Sector-Wise Career Opportunities</h2>
                        ...
                        <button className="bg-white text-accent px-8 py-3 rounded-full font-bold hover:bg-gray-100 transition-colors shadow-lg">
                            Explore Programs
                        </button>
                    </RevealOnScroll>
                        ...
                        {sectors.map((sector, index) => (
                            <RevealOnScroll key={index} delay={index * 100}>
                                <div className="bg-white/10 backdrop-blur-sm p-6 rounded-xl border border-white/20 hover:bg-white/20 transition-colors">
                                    <sector.icon className="w-8 h-8 text-white mb-4" />
                                    <h3 className="text-xl font-bold mb-2">{sector.title}</h3>
                                    <p className="text-sm text-white/80">{sector.desc}</p>
                                </div>
                            </RevealOnScroll>
                        ))}
                    </div>
