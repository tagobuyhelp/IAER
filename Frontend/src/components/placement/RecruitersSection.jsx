            ...
            <div className="container mx-auto px-4">
                ...
                <div className="mb-20">
                    <div className="text-center mb-12">
                        <RevealOnScroll>
                            <h2 className="text-3xl font-bold text-primary mb-4">Placement Activities at IAER</h2>
                            <p className="text-gray-600">A comprehensive ecosystem designed for success.</p>
                        </RevealOnScroll>
                    </div>
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {activities.map((item, index) => (
                            <RevealOnScroll key={index} delay={index * 100}>
                                <div className="p-6 bg-gray-50 rounded-xl border border-gray-100 hover:shadow-lg transition-all duration-300 text-center group">
                ...
                <div>
                    <div className="text-center mb-12">
                        <RevealOnScroll>
                            <h2 className="text-3xl font-bold text-primary mb-4">Recruitment Ecosystem</h2>
                    ...
                    <RevealOnScroll delay={200}>
                        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 items-center opacity-80 grayscale hover:grayscale-0 transition-all duration-500">
