...
import {
  ...
  Banknote, ClipboardCheck, School, Hotel, Quote, CircleDollarSign, Target, Video, GraduationCap, MapPin, BarChart, Settings, MonitorPlay, ArrowRight, Menu, X, Layers, Search, Terminal, Cloud, Database, PieChart, Calculator
} from 'lucide-react';
...
export default function DataScienceLandingPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 scroll-smooth font-sans pb-20 sm:pb-0">
      ...
      <div className="relative w-full border-b border-white/10 bg-slate-900 text-[11px] text-white shadow-sm sm:text-sm">
      ...
      {/* Header */}
      <header className="sticky top-0 z-40 border-b border-white/10 bg-slate-900/95 backdrop-blur shadow-lg">
      ...
      {/* --- HERO --- */}
      <section className="relative overflow-hidden bg-slate-900 pt-6 sm:pt-8 pb-8 sm:pb-12 border-b border-white/10">
        <div className="absolute inset-0 z-0 pointer-events-none">
          ...
          <div className="absolute inset-0 bg-gradient-to-br from-slate-900/95 via-[#0b1c3a]/80 to-slate-900/95 mix-blend-multiply" />
          ...
          <div data-animate-on-scroll className="relative z-10 mx-auto grid max-w-[1550px] grid-cols-1 gap-4 sm:gap-6 px-4 py-4 md:grid-cols-12 md:gap-6 md:py-6 transition-all duration-700 ease-out">
            <div className="flex-1 md:col-span-7 space-y-3 sm:space-y-4">
              ...
              <div className="inline-flex items-center gap-1.5 sm:gap-2 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 px-2.5 py-1 sm:px-3 sm:py-1.5 text-[11px] sm:text-xs font-medium text-white shadow-sm">
                ...
                <span>Best Data Science College in Kolkata with Placement & Global Exposure</span>
              </div>
              ...
              <div className="mt-3 flex flex-wrap items-center gap-2 sm:mt-6 sm:gap-3">
                {[
                  { label: 'AI, Machine Learning & Data Analytics', icon: ShieldCheck },
            ...
            <div id="enquiry-form-section" className="flex flex-col md:col-span-5 items-center justify-center gap-4 sm:gap-5 mt-4 md:mt-0 w-full relative z-20">
              ...
              <div className="w-full mt-2 lg:-ml-4">
                ...
                <div className="relative flex overflow-hidden w-full group mask-image-linear-gradient">
                  {/* Fade edges */}
                  <div className="pointer-events-none absolute left-0 top-0 z-10 h-full w-8 bg-gradient-to-r from-slate-900 to-transparent"></div>
                  <div className="pointer-events-none absolute right-0 top-0 z-10 h-full w-8 bg-gradient-to-l from-slate-900 to-transparent"></div>
                        ...
                        {[
                          ...
                          <div key={`${i}-${idx}`} className="flex items-center gap-2.5 bg-white/95 backdrop-blur-sm rounded-xl p-2 pr-4 shadow-[0_4px_15px_rgba(0,0,0,0.1)] border border-white/40 min-w-max transition-transform hover:-translate-y-0.5">
                            ...
                            <div className="flex flex-col">
                              <span className="text-[11px] font-extrabold text-slate-900 whitespace-nowrap">{student.name}</span>
        ...
        <div data-animate-on-scroll className="relative z-10 mx-auto max-w-[1200px] px-4 flex flex-col items-center">
          ...
          <div className="flex flex-col md:flex-row w-full gap-6 md:gap-10 items-center justify-between mb-8">
            ...
            <div className="flex flex-wrap sm:flex-nowrap gap-3 sm:gap-4 w-full md:w-auto">
              <div className="flex-1 bg-gradient-to-br from-slate-900 to-[#0b1c3a] p-4 rounded-2xl shadow-md text-white text-center flex flex-col justify-center min-w-[120px] hover:-translate-y-1 transition-transform">
              ...
              <div className="flex-1 bg-white border border-slate-200 p-4 rounded-2xl shadow-sm text-center flex flex-col justify-center min-w-[100px] hover:-translate-y-1 transition-transform">
                ...
                <div className="text-2xl sm:text-3xl font-extrabold text-slate-900">₹4.5+</div>
              </div>
              <div className="flex-1 bg-white border border-slate-200 p-4 rounded-2xl shadow-sm text-center flex flex-col justify-center min-w-[100px] hover:-translate-y-1 transition-transform">
          ...
          <div className="flex flex-col md:flex-row w-full justify-between items-center gap-5">
            <div className="flex flex-wrap justify-center md:justify-start gap-2 max-w-2xl">
              {[
                ...
                <span key={role.name} className="inline-flex items-center gap-1.5 bg-white text-slate-600 rounded-full px-3 py-1.5 text-[10px] sm:text-xs font-semibold border border-slate-200 shadow-sm cursor-default hover:text-slate-900 hover:border-primary/30 transition-colors">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mt-8">
            {[
              ...
              <div key={spec.id} className="group relative bg-white border border-slate-200 rounded-2xl p-5 hover:shadow-xl transition-all duration-300 hover:-translate-y-1 overflow-hidden flex flex-col h-full">
                ...
                <h3 className="text-lg font-bold text-slate-900 mb-2 leading-tight">{spec.title}</h3>
 ...
 {/* --- VIDEO TESTIMONIALS --- */}
      <section className="py-10 sm:py-16 bg-slate-900 relative overflow-hidden">
      ...
      <section id="why-iaer" className="relative border-b border-slate-200 bg-slate-50 py-10 sm:py-16 overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-[1550px] px-4">
          <div className="text-center mb-10 sm:mb-14">
            <span className="text-[10px] sm:text-[11px] font-bold uppercase tracking-widest text-slate-900 mb-2 block">Excellence in Education</span>
          ...
          <div className="grid lg:grid-cols-12 gap-8 lg:gap-12 items-start mb-12">
            ...
            <div className="lg:col-span-5 flex flex-col gap-5 sm:gap-6">
              <div className="relative h-[250px] sm:h-[320px] lg:h-[280px] overflow-hidden rounded-3xl shadow-2xl ring-1 ring-slate-200 group">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-slate-900/90 via-[#143674]/20 to-transparent" />
                <div className="absolute bottom-0 left-0 right-0 p-6">
                  <h3 className="text-xl sm:text-2xl font-bold text-white mb-2 flex items-center gap-2"><BookOpen className="w-6 h-6 text-accent" /> About B.Sc. Data Science at IAER</h3>
          ...
          <div className="bg-slate-900 rounded-3xl p-6 sm:p-8 shadow-xl relative overflow-hidden">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-6 relative z-10">
              ...
              <div className="flex-1 w-full overflow-hidden relative">
                {/* Fade edges */}
                <div className="absolute top-0 bottom-0 left-0 w-8 bg-gradient-to-r from-slate-900 to-transparent z-10 pointer-events-none" />
                <div className="absolute top-0 bottom-0 right-0 w-8 bg-gradient-to-l from-slate-900 to-transparent z-10 pointer-events-none" />
      ...
      <section className="relative py-8 sm:py-10 bg-white border-b border-slate-200">
        <div className="mx-auto max-w-[1550px] px-4">
          <div className="text-center mb-6 sm:mb-8">
            <h2 className="text-2xl sm:text-3xl font-bold text-slate-900 mb-2">Voices of Success</h2>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <div className="min-w-0">
              <h3 className="text-lg font-semibold text-slate-900 flex items-center gap-2 mb-4"><GraduationCap className="w-5 h-5 text-primary" /> Student Testimonials</h3>
            ...
            <div className="min-w-0">
              <h3 className="text-lg font-semibold text-slate-900 flex items-center gap-2 mb-4"><Briefcase className="w-5 h-5 text-primary" /> Industry Testimonials</h3>
              <div className="flex gap-4 overflow-x-auto pb-4 pt-1 snap-x snap-mandatory no-scrollbar">
                {[
      ...
      <section id="campus-facilities" className="py-8 sm:py-10 bg-slate-50 border-b border-slate-200">
        <div className="mx-auto max-w-[1550px] px-4">
          <div className="grid lg:grid-cols-2 gap-6 sm:gap-8">
            ...
            <div>
              <h2 className="text-2xl font-bold text-slate-900 mb-4 flex items-center gap-2"><Video className="w-6 h-6 text-accent" /> Campus & Learning Experience</h2>
            ...
            <div className="space-y-6 sm:space-y-8">
              <div className="bg-white rounded-3xl p-5 sm:p-6 shadow-sm ring-1 ring-slate-200">
                <h2 className="text-lg font-bold text-slate-900 mb-1 flex items-center gap-2"><Hotel className="w-5 h-5 text-primary" /> Hostel & Campus Facilities</h2>
              ...
              <div className="bg-gradient-to-br from-blue-50 to-white rounded-3xl p-5 sm:p-6 shadow-sm ring-1 ring-blue-100 relative overflow-hidden group">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-4 relative z-10">
                  <h2 className="text-lg font-bold text-slate-900 flex items-center gap-2"><Banknote className="w-5 h-5 text-primary" /> Scholarships & Loans</h2>
                ...
                <div className="flex flex-wrap gap-2 relative z-10">
                  {[
                    ...
                    <span key={i} className="inline-flex items-center gap-1.5 bg-white border border-blue-100 shadow-sm rounded-lg px-3 py-2 text-[11px] sm:text-xs font-bold text-slate-900 hover:shadow-md transition-shadow">
      ...
      <section className="py-10 sm:py-16 bg-slate-50 border-b border-slate-200">
        <div className="mx-auto max-w-[800px] px-4">
          <div className="text-center mb-10 sm:mb-12">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-slate-900 mb-3">Frequently Asked Questions</h2>
          ...
          <div className="flex flex-col gap-3">
            {[
              ...
              <div key={i} className="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden transition-all duration-300">
                ...
                >
                  <span className={`font-bold text-sm sm:text-base pr-4 ${openFaq === i ? 'text-primary' : 'text-slate-900'}`}>{faq.q}</span>
      ...
      {/* --- FOOTER CTA --- */}
      <footer className="bg-slate-900 border-t border-white/10 pt-8 sm:pt-10 pb-6">
      ...
      <div className="fixed bottom-0 md:bottom-6 left-0 right-0 md:left-1/2 md:right-auto md:-translate-x-1/2 z-[60] w-full md:w-max bg-white/95 backdrop-blur-xl border-t md:border border-slate-200/80 md:rounded-full shadow-[0_-10px_40px_rgba(0,0,0,0.08)] p-1.5 md:p-2 flex items-center justify-between gap-2 transition-all duration-300">
        ...
        <div className="flex items-center gap-1.5 sm:gap-2 flex-shrink-0 pr-1">
          ...
          <a href="tel:+916292004641" className="h-9 sm:h-10 bg-slate-900 hover:bg-slate-900/90 text-white font-extrabold rounded-full px-3 sm:px-5 text-[11px] sm:text-xs shadow-lg shadow-[#143674]/20 active:scale-95 transition-all flex items-center justify-center gap-1.5 whitespace-nowrap">
