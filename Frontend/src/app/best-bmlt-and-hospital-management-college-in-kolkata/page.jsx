          ...
          <div data-animate-on-scroll className="relative z-10 mx-auto grid max-w-[1550px] grid-cols-1 gap-3 sm:gap-4 px-4 py-3 sm:py-4 md:grid-cols-12 md:gap-6 md:py-6 transition-all duration-700 ease-out">
            <div className="flex-1 md:col-span-7 space-y-1.5 sm:space-y-3">
              ...
              <div className="inline-flex items-center gap-1.5 sm:gap-2 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 px-2.5 py-0.5 sm:px-3 sm:py-1 text-[11px] sm:text-xs font-medium text-white shadow-sm">
                ...
                <span>Best Healthcare & Hospital Management College in Kolkata</span>
              </div>
              ...
              <div className="space-y-1 sm:space-y-2">
                <h1 className="text-xl sm:text-3xl lg:text-[2.75rem] font-extrabold tracking-tighter text-white drop-shadow-lg leading-tight sm:leading-[1.1]">
                  Build a High-Growth Career in <br className="hidden sm:block" />
                  <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary via-teal-300 to-white">Healthcare & Hospital Management</span>
                </h1>
                <p className="text-[10px] sm:text-base lg:text-lg font-medium text-blue-100/90 drop-shadow max-w-full sm:max-w-3xl leading-tight sm:leading-relaxed">
                  Looking for BMLT course in Kolkata or hospital management course after 12th? Join IAER—one of the top healthcare colleges in Kolkata offering medical lab technology and hospital administration programs.
                </p>
              ...
              <div className="mt-3 flex flex-wrap items-center gap-2 sm:mt-6 sm:gap-4">
                {[
                  { label: 'Internship in Hospitals & Diagnostic Labs', icon: Briefcase },
                  { label: 'Industry-Aligned Healthcare Curriculum', icon: BookOpen },
                  { label: 'Hands-on Practical Training', icon: Building2 },
                   ...
                   {[...Array(2)].map((_, i) => (
                     <React.Fragment key={i}>
                       <span className="inline-flex items-center gap-1.5 text-[11px] lg:text-xs font-semibold text-white/90 whitespace-nowrap">
                         <Award className="h-3.5 w-3.5 text-accent" /> AICTE & NSDC Approved
                       </span>
                       <span className="inline-flex items-center gap-1.5 text-[11px] lg:text-xs font-semibold text-white/90 whitespace-nowrap">
                         <Briefcase className="h-3.5 w-3.5 text-primary" /> ₹3.50+ LPA Avg Package
                       </span>
                       <span className="inline-flex items-center gap-1.5 text-[11px] lg:text-xs font-semibold text-white/90 whitespace-nowrap">
                         <Globe className="h-3.5 w-3.5 text-teal-400" /> Affiliated to MAKAUT
                       </span>
                       <span className="inline-flex items-center gap-1.5 text-[11px] lg:text-xs font-semibold text-white/90 whitespace-nowrap">
                         <Building2 className="h-3.5 w-3.5 text-blue-400" /> ₹8.00+ LPA Highest Package
                       </span>
                     </React.Fragment>
                   ))}
                 </div>
          ...
          <div className="grid gap-6 md:grid-cols-2 items-center">
            ...
            <div className="order-1 md:order-2 flex flex-col justify-center">
              <div className="flex items-center gap-2 mb-3">
                ...
                <h2 className="text-xl sm:text-2xl font-bold font-sans text-[#143674]">About The Programs</h2>
              </div>
              <div className="mb-4 h-1 w-20 rounded-full bg-primary" />
              <div className="prose prose-sm max-w-none text-slate-700">
                <p className="leading-relaxed text-base">
                  IAER is among the best healthcare colleges in Kolkata, offering career-focused programs in BMLT (Medical Laboratory Technology) and BBA in Hospital Management.
                </p>

                <div className="mt-4 text-sm font-medium text-slate-600">
                  <p className="mb-2 uppercase tracking-widest text-[10px] text-[#143674] font-bold">If you're searching for:</p>
                  <div className="flex flex-wrap gap-2">
                    {['paramedical courses in Kolkata', 'healthcare management degree Kolkata', 'medical lab technology course after 12th'].map((tag) => (
                ...
                <div className="mt-5 bg-gradient-to-br from-[#143674] to-[#0b1c3a] rounded-2xl p-5 shadow-lg relative overflow-hidden group">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 relative z-10">
                    {[
                      { label: 'Practical lab-based training' },
                      { label: 'Hospital internships' },
      ...
      <section id="specializations" className="relative border-b border-slate-200 bg-white">
        <div data-animate-on-scroll className="mx-auto max-w-[1200px] px-4 py-6 sm:py-8">
          <div className="flex flex-col gap-1 mb-6 text-center sm:text-left">
            <span className="text-[10px] sm:text-[11px] font-bold uppercase tracking-widest text-primary">Explore Your Options</span>
            <h2 className="text-2xl sm:text-4xl font-extrabold text-[#143674] tracking-tight">
              Choose Your <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-teal-500">Program</span>
            </h2>
            <p className="text-sm sm:text-base font-medium text-slate-600 mt-2">Specialized healthcare pathways designed for dynamic industry demands</p>
            <div className="mx-auto sm:mx-0 mt-4 h-1.5 w-24 rounded-full bg-accent shadow-sm" />
          </div>

          <div className="grid md:grid-cols-2 gap-6 lg:gap-8">
            {programs.map((prog) => (
               <div key={prog.id} className="group flex flex-col rounded-2xl bg-white shadow-sm ring-1 ring-slate-200 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:ring-primary/30 relative overflow-hidden">
                  ...
                  <div className="h-48 overflow-hidden relative">
                    <div className="absolute inset-0 bg-[#143674]/20 group-hover:bg-transparent transition-colors duration-500 z-10" />
                    <img src={prog.image} alt={prog.name} className="w-full h-full object-cover transform group-hover:scale-110 transition-transform duration-700 ease-out" />
                    <div className="absolute bottom-0 left-0 right-0 h-24 bg-gradient-to-t from-[#143674] to-transparent z-10 opacity-90" />
                    <div className="absolute bottom-4 left-5 right-5 z-20">
                       <h3 className="text-xl font-bold text-white mb-1 leading-tight">{prog.name}</h3>
                    </div>
                  </div>
                  ...
                  <div className="p-6 flex flex-col flex-grow">
                    ...
                    <div className="space-y-4 mb-6">
                      <div>
                        <h4 className="text-xs font-bold text-[#143674] uppercase tracking-wider mb-2 flex items-center gap-1.5"><BookOpen className="w-3.5 h-3.5 text-primary" /> What You Will Learn</h4>
                      ...
                      <div>
                        <h4 className="text-xs font-bold text-[#143674] uppercase tracking-wider mb-2 flex items-center gap-1.5"><Target className="w-3.5 h-3.5 text-primary" /> Career Roles</h4>
                        <ul className="grid grid-cols-2 gap-2">
                           {prog.roles.map((item, i) => (
                             <li key={i} className="text-xs text-slate-600 flex items-start gap-1.5">
      ...
      <section id="placements" className="relative border-b border-slate-200 bg-slate-50">
        <div data-animate-on-scroll className="mx-auto max-w-[1550px] px-4 py-8 sm:py-10">
          <div className="flex flex-col gap-1 mb-6">
            ...
            <p className="text-sm sm:text-base font-medium text-slate-600 mt-2">Launch Your Career in Healthcare with Strong Placement Support</p>
            ...
            <div className="lg:col-span-5 flex flex-col gap-3 sm:gap-4">
              <div className="relative rounded-3xl bg-gradient-to-br from-[#143674] via-[#0b1c3a] to-[#143674] p-6 sm:p-8 text-white shadow-xl overflow-hidden group min-h-[160px] flex items-center">
                 ...
                 <div className="relative z-10 flex flex-col justify-center w-full">
                    ...
                    <div className="text-5xl sm:text-6xl font-extrabold drop-shadow-lg text-transparent bg-clip-text bg-gradient-to-r from-white to-blue-200">₹8.00<span className="text-2xl sm:text-3xl text-white/80">+ LPA</span></div>
                 </div>
              </div>
                 ...
                 <div className="rounded-2xl bg-white p-3 sm:p-5 ring-1 ring-slate-200 shadow-sm flex flex-col items-center justify-center text-center hover:shadow-md transition-shadow relative overflow-hidden group">
                   ...
                   <div className="text-2xl sm:text-4xl font-extrabold text-[#143674] mb-1">₹3.50+</div>
                 ...
                 <div className="rounded-2xl bg-white p-3 sm:p-5 ring-1 ring-slate-200 shadow-sm flex flex-col items-center justify-center text-center hover:shadow-md transition-shadow relative overflow-hidden group">
                   ...
                   <div className="text-2xl sm:text-4xl font-extrabold text-[#143674] mb-1">₹8.00+</div>
                 ...
                 <div className="rounded-2xl bg-white p-3 sm:p-5 ring-1 ring-slate-200 shadow-sm flex flex-col items-center justify-center text-center hover:shadow-md transition-shadow relative overflow-hidden group">
                   ...
                   <div className="text-slate-500 text-[10px] sm:text-xs font-semibold uppercase tracking-wider">Hospital & Lab Internships</div>
                 </div>
              </div>
            </div>
               ...
               <div className="rounded-3xl bg-white p-5 sm:p-6 ring-1 ring-slate-200 shadow-sm flex-grow flex flex-col gap-5 sm:gap-6">
                 ...
                 <div>
                    ...
                    <div className="flex flex-wrap items-center gap-2 sm:gap-3 bg-slate-50 p-4 rounded-2xl border border-slate-100">
                       {['Hospitals', 'Diagnostic Chains', 'Healthcare Companies', 'Multispecialty Clinics'].map((recruiter) => (
                 ...
                 <div>
                   ...
                   <div className="flex flex-wrap gap-2 sm:gap-2.5">
                     {['Medical Lab Technologist', 'Pathology Technician', 'Hospital Administrator', 'Healthcare Manager', 'Operations Executive', 'Diagnostic Specialist'].map((role) => (
            ...
            <div className="grid md:grid-cols-2 gap-6">
               ...
               <div className="min-w-0">
                  ...
                  <div className="flex gap-4 overflow-x-auto pb-4 pt-1 snap-x snap-mandatory no-scrollbar">
                     {[
                       { name: 'Malay Sarkar', title: 'Medical Lab Technologist', company: 'Apollo Diagnostics', quote: 'The BMLT program gave me hands-on lab training and helped me secure a job in a diagnostic center.' },
                       { name: 'Arnab Pal', title: 'Hospital Operations Executive', company: 'Ankura Hospitals', quote: 'The hospital management course helped me understand real hospital operations and patient care systems.' }
                     ].map((t, i) => (
      ...
      <section className="py-8 sm:py-10 bg-white">
        <div className="mx-auto max-w-[1000px] px-4">
          ...
          <div className="grid md:grid-cols-2 gap-4">
            {[
              { q: 'Does IAER provide placement support for BMLT and Hospital Management students?', a: 'Yes, IAER provides structured placement support with internships and recruiter access.' },
              { q: 'What are the job opportunities after BMLT?', a: 'Medical Lab Technologist, Pathology Technician, Lab Manager.' },
              { q: 'What are the career options after Hospital Management?', a: 'Hospital Administrator, Healthcare Manager, Operations Executive.' },
              { q: 'Does IAER help with education loans?', a: 'Yes, IAER assists with loan applications and documentation.' },
              { q: 'Can I apply for Student Credit Card Scheme?', a: 'Yes, eligible students can apply for financial support.' },
              { q: 'Does IAER provide hostel facilities?', a: 'Yes, safe and comfortable hostels are available for boys and girls.' },
              { q: 'What facilities are included in hostel?', a: 'Food, Wi-Fi, security, furnished rooms.' },
              { q: 'Does IAER offer international programs?', a: 'Yes, international immersion programs are available.' },
              { q: 'What is the benefit of international exposure?', a: 'Improves global knowledge, confidence, and career opportunities.' },
              { q: 'Are internships included?', a: 'Yes, practical hospital and lab training is part of the program.' },
              { q: 'What is the average salary after these courses?', a: '₹3.5 LPA average with growth opportunities.' }
            ].map((faq, i) => (
